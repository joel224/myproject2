...
"[project]/.next-internal/server/app/api/staff/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
;
const staffRoleEnum = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].enum([
    'Dentist',
    'Hygienist',
    'Assistant',
    'Receptionist',
...
const createStaffSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(2, "Name must be at least 2 characters long"),
    role: staffRoleEnum
});
// Helper to map UserAuth role to StaffMember role for API response consistency
function mapUserAuthRoleToStaffMemberRole(userAuthRole) {
    switch(userAuthRole){
        case 'doctor':
            return 'Dentist';
        case 'hygienist':
        ...
        case 'assistant':
            return 'Assistant';
        case 'staff':
            return 'Receptionist'; // Assuming 'staff' in UserAuth is 'Receptionist' for StaffMember
        case 'admin':
            return 'Admin';
        default:
            return null; // 'patient' or other roles not relevant here
    }
}
async function POST(request) {
    ...
    try {
        ...
        const email = `${simpleName}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.filter((u)=>u.role !== 'patient').length + 1}${emailSuffix}`;
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.some((u)=>u.email === email)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Generated email already exists, try a slightly different name."
            }, {
                status: 409
            });
        }
        const newStaffUserId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])('staff_');
        ...
        const newUser = {
            ...
            name,
            email,
            passwordHash: `$2a$10$mockStaffPassword${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])()}`,
            role: userAuthRole,
            createdAt: new Date().toISOString(),
            updatedAt: new Date().toISOString()
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.push(newUser);
        // Return data in the StaffMember format
        const newStaffMemberResponse = {
            id: newStaffUserId,
            name,
            email,
            role: staffMemberRole
        };
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newStaffMemberResponse, {
            status: 201
        });
    } catch (error) {
        console.error('Error creating staff member:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Error creating staff member. Please check logs.'
        }, {
            status: 500
        });
    }
...
async function GET(request) {
    ...
    let staffList = staffUsers.map((user)=>({
            id: user.id,
            name: user.name,
            email: user.email,
            role: mapUserAuthRoleToStaffMemberRole(user.role)
        }));
    staffList.sort((a, b)=>a.name.localeCompare(b.name));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(staffList, {
        status: 200
    });
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5a348fe8._.js.map