...
"[project]/.next-internal/server/app/api/appointments/[appointmentId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/appointments/[appointmentId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const updateAppointmentSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    patientId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1).optional(),
    doctorId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1).optional(),
    date: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().regex(/^\d{4}-\d{2}-\d{2}$/, "Date must be in YYYY-MM-DD format").optional(),
    time: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9] (AM|PM)$/, "Time must be in HH:MM AM/PM format").optional(),
    type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1).optional(),
...
async function GET(request, { params }) {
    ...
    const appointment = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointments.find((apt)=>apt.id === appointmentId);
    if (!appointment) {
    ...
    const patient = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === appointment.patientId && u.role === 'patient');
    const doctor = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === appointment.doctorId && (u.role === 'doctor' || u.role === 'staff' || u.role === 'hygienist' || u.role === 'assistant' || u.role === 'admin'));
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(populatedAppointment, {
        status: 200
    });
}
async function PUT(request, { params }) {
    ...
    // }
    const { appointmentId } = params;
    const appointmentIndex = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointments.findIndex((apt)=>apt.id === appointmentId);
    ...
    try {
        ...
        const currentAppointment = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointments[appointmentIndex];
        const updatedAppointment = {
            ...currentAppointment
        };
        if (updateData.patientId) {
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.some((u)=>u.id === updateData.patientId && u.role === 'patient')) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Patient with ID ${updateData.patientId} not found.`
                }, {
                    status: 404
                });
            }
            updatedAppointment.patientId = updateData.patientId;
            updatedAppointment.patientName = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === updateData.patientId)?.name;
        }
        if (updateData.doctorId) {
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.some((u)=>u.id === updateData.doctorId && (u.role === 'doctor' || u.role === 'staff' || u.role === 'hygienist' || u.role === 'assistant' || u.role === 'admin'))) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Doctor/Staff with ID ${updateData.doctorId} not found.`
                }, {
                    status: 404
                });
            }
            updatedAppointment.doctorId = updateData.doctorId;
            updatedAppointment.doctorName = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === updateData.doctorId)?.name;
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointments[appointmentIndex] = updatedAppointment;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedAppointment, {
            status: 200
        });
    } catch (error) {
...
async function DELETE(request, { params }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointments.splice(appointmentIndex, 1);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1ccbdffb._.js.map