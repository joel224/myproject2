...
"[project]/.next-internal/server/app/api/invoices/[invoiceId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/invoices/[invoiceId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const updateInvoiceSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
...
async function PUT(request, { params }) {
    ...
    // if (!authResult.authorized || !authResult.user) { return authResult.error; }
    const { invoiceId } = params;
    const invoiceIndex = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoices.findIndex((inv)=>inv.id === invoiceId);
    if (invoiceIndex === -1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Invoice not found"
        }, {
    ...
    try {
        ...
        const currentInvoice = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoices[invoiceIndex];
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockServerDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoices[invoiceIndex] = updatedInvoice;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0c89a6f1._.js.map