...
function getCSSRule(styleParent, predicate) {
  ...
  for (style of (_a4 = styleParent.querySelectorAll("style:not([media])")) != null ? _a4 : []) {
    let cssRules;
    try {
      cssRules = (_b3 = style.sheet) == null ? void 0 : _b3.cssRules;
    } catch {
      continue;
    }
...
function insertCSSRule(styleParent, selectorText) {
  ...
  return (
    /** @type {CSSStyleRule} */
    (_b3 = style.sheet.cssRules) == null ? void 0 : _b3[style.sheet.cssRules.length - 1]
  );
}
...
var MediaGestureReceiver = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b3 = (_a4 = __privateGet(this, _mediaController)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (this.getAttribute(MediaStateReceiverAttributes.MEDIA_CONTROLLER)) {
      (_b3 = (_a4 = __privateGet(this, _mediaController)) == null ? void 0 : _a4.associateElement) == null ? void 0 : _b3.call(_a4, this);
    }
...
var AttributeTokenList = class {
  ...
  add(...tokens) {
    ...
    (_b3 = __privateGet3(this, _el)) == null ? void 0 : _b3.setAttribute(`${__privateGet3(this, _attr)}`, `${this.value}`);
  }
  remove(...tokens) {
    var _a4;
...
var getTestMediaEl = () => {
  ...
  if (testMediaEl)
    return testMediaEl;
  testMediaEl = (_b3 = (_a4 = Document2) == null ? void 0 : _a4.createElement) == null ? void 0 : _b3.call(_a4, "video");
  return testMediaEl;
};
...
var stateMediator = {
  ...
  mediaErrorMessage: {
    get(stateOwners, event) {
      ...
      if ((event == null ? void 0 : event.type) === "playing")
        return;
      return (_b3 = (_a4 = media == null ? void 0 : media.error) == null ? void 0 : _a4.message) != null ? _b3 : "";
    },
    mediaEvents: ["emptied", "error", "playing"]
  },
  mediaWidth: {
  ...
  mediaSubtitlesShowing: {
    ...
    stateOwnersUpdateHandlers: [
      (_handler, stateOwners) => {
        ...
        (_b3 = media.textTracks) == null ? void 0 : _b3.addEventListener(
          "removetrack",
          updateDefaultSubtitlesCallback
        );
        return () => {
      ...
      if (documentElement.pictureInPictureElement.localName.includes("-")) {
        ...
        while (currentRoot == null ? void 0 : currentRoot.pictureInPictureElement) {
          if (currentRoot.pictureInPictureElement === media)
            return true;
          currentRoot = (_b3 = currentRoot.pictureInPictureElement) == null ? void 0 : _b3.shadowRoot;
        }
      }
      return false;
    },
  ...
  mediaRenditionSelected: {
    get(stateOwners) {
      var _a4, _b3, _c;
      const { media } = stateOwners;
      return (_c = (_b3 = media == null ? void 0 : media.videoRenditions) == null ? void 0 : _b3[(_a4 = media.videoRenditions) == null ? void 0 : _a4.selectedIndex]) == null ? void 0 : _c.id;
    },
    set(value, stateOwners) {
      const { media } = stateOwners;
  ...
  mediaAudioTrackEnabled: {
    get(stateOwners) {
      var _a4, _b3;
      const { media } = stateOwners;
      return (_b3 = [...(_a4 = media == null ? void 0 : media.audioTracks) != null ? _a4 : []].find(
  ...
  mediaIsCasting: {
    ...
    set(value, stateOwners) {
      ...
      if (value && ((_a4 = media.remote) == null ? void 0 : _a4.state) !== "disconnected")
        return;
      if (!value && ((_b3 = media.remote) == null ? void 0 : _b3.state) !== "connected")
        return;
  ...
  mediaAudioTrackUnavailable: {
    get(stateOwners) {
      ...
      if (((_b3 = (_a4 = media.audioTracks) == null ? void 0 : _a4.length) != null ? _b3 : 0) <= 1) {
        return AvailabilityStates.UNAVAILABLE;
      }
      return void 0;
    },
...
var requestMap = {
  ...
  [MediaUIEvents.MEDIA_PREVIEW_REQUEST](stateMediator2, stateOwners, { detail }) {
    ...
    if (media && mediaPreviewTime != null) {
      ...
      if (cue) {
        const base = !/'^(?:[a-z]+:)?\/\//i.test(cue.text) ? (_b3 = media == null ? void 0 : media.querySelector(
          'track[label="thumbnails"]'
        )) == null ? void 0 : _b3.src : void 0;
  ...
  [MediaUIEvents.MEDIA_PLAY_REQUEST](stateMediator2, stateOwners) {
    ...
    if (isLive && canAutoSeekToLive && !isDVR) {
      const seekableEnd = (_b3 = stateMediator2.mediaSeekable.get(stateOwners)) == null ? void 0 : _b3[1];
      if (seekableEnd) {
  ...
  [MediaUIEvents.MEDIA_SEEK_TO_LIVE_REQUEST](stateMediator2, stateOwners) {
    ...
    if (Number.isNaN(Number(seekableEnd)))
      return;
    const seekToLiveOffset = (_c = (_b3 = stateOwners.options) == null ? void 0 : _b3.seekToLiveOffset) != null ? _c : 0;
...
var createMediaStore = ({
  ...
  const updateStateOwners = async (nextStateOwnersDelta, nextSubscriberCount) => {
    var _a4, _b3, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
    ...
    const textTracksChanged = ((_a4 = stateOwners.media) == null ? void 0 : _a4.textTracks) !== ((_b3 = nextStateOwners.media) == null ? void 0 : _b3.textTracks);
...
var MediaController = class extends MediaContainer {
  ...
  set mediaStore(value) {
    ...
    __privateSet4(this, _mediaStoreUnsubscribe, (_b3 = __privateGet4(this, _mediaStore)) == null ? void 0 : _b3.subscribe(
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes2.NO_HOTKEYS) {
      ...
      (_c = __privateGet4(this, _mediaStore)) == null ? void 0 : _c.dispatch({
        type: "optionschangerequest",
        detail: {
          defaultStreamType: (_b3 = this.getAttribute(Attributes2.DEFAULT_STREAM_TYPE)) != null ? _b3 : void 0
        }
      });
  ...
  disconnectedCallback() {
    ...
    if (__privateGet4(this, _mediaStore)) {
      (_b3 = __privateGet4(this, _mediaStore)) == null ? void 0 : _b3.dispatch({
        type: "documentelementchangerequest",
        detail: void 0
      });
      (_c = __privateGet4(this, _mediaStore)) == null ? void 0 : _c.dispatch({
  ...
  keyboardShortcutHandler(e) {
    ...
    const keysUsed = ((_c = (_b3 = (_a4 = target.getAttribute(Attributes2.KEYS_USED)) == null ? void 0 : _a4.split(" ")) != null ? _b3 : target == null ? void 0 : target.keysUsed) != null ? _c : []).map((key) => key === "Space" ? " " : key).filter(Boolean);
...
var getMediaUIAttributesFrom = (child) => {
  ...
  const mediaChromeAttributesList = (_d = (_c = (_b3 = child == null ? void 0 : child.getAttribute) == null ? void 0 : _b3.call(child, MediaStateReceiverAttributes.MEDIA_CHROME_ATTRIBUTES)) == null ? void 0 : _c.split) == null ? void 0 : _d.call(_c, /\s+/);
...
var hasMediaUIProps = (mediaStateReceiverCandidate) => {
  ...
  if (((_a4 = mediaStateReceiverCandidate.nodeName) == null ? void 0 : _a4.includes("-")) && !!GlobalThis.customElements.get(
    (_b3 = mediaStateReceiverCandidate.nodeName) == null ? void 0 : _b3.toLowerCase()
...
var setAttr = async (child, attrName, attrValue) => {
  ...
  const val = (_b3 = (_a4 = CustomAttrSerializer[attrName]) == null ? void 0 : _a4.call(CustomAttrSerializer, attrValue)) != null ? _b3 : attrValue;
...
var traverseForMediaStateReceivers = (rootNode, mediaStateReceiverCallback) => {
  ...
  const traverseForMediaStateReceiversSync = (rootNode2, mediaStateReceiverCallback2) => {
    ...
    const shadowChildren = (_b3 = (_a4 = rootNode2 == null ? void 0 : rootNode2.shadowRoot) == null ? void 0 : _a4.children) != null ? _b3 : [];
...
var MediaChromeButton = class extends GlobalThis.HTMLElement {
  constructor(options = {}) {
    ...
    __privateAdd5(this, _positionTooltip, () => {
      var _a5, _b3;
      (_b3 = (_a5 = this.tooltipEl) == null ? void 0 : _a5.updateXOffset) == null ? void 0 : _b3.call(_a5);
    });
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b3 = (_a4 = __privateGet5(this, _mediaController2)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet5(this, _mediaController2)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
...
handleKeyDown_fn = function(event) {
  ...
  if (key === "Tab") {
    if (event.shiftKey) {
      (_b3 = (_a4 = this.previousElementSibling) == null ? void 0 : _a4.focus) == null ? void 0 : _b3.call(_a4);
    } else {
...
var MediaChromeRange = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b3 = (_a4 = __privateGet7(this, _mediaController3)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet7(this, _mediaController3)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
    this.updateBar();
  ...
  updateBar() {
    ...
    (_b3 = __privateGet7(this, _cssRules).thumb) == null ? void 0 : _b3.style.setProperty("left", `${rangePercent}%`);
  }
...
disableUserEvents_fn = function() {
  ...
  (_b3 = GlobalThis.window) == null ? void 0 : _b3.removeEventListener("pointermove", this);
};
...
handlePointerLeave_fn = function() {
  ...
  this.toggleAttribute("dragging", false);
  this.range.disabled = this.hasAttribute("disabled");
  (_b3 = __privateGet7(this, _cssRules).activeSegment) == null ? void 0 : _b3.style.removeProperty("transform");
};
...
var MediaControlBar = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b3 = (_a4 = __privateGet8(this, _mediaController4)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet8(this, _mediaController4)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b3;
...
var MediaTextDisplay = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b3 = (_a4 = __privateGet9(this, _mediaController5)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet9(this, _mediaController5)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b3;
...
var formatError = (error) => {
  ...
  return {
    ...
    message: (_b3 = defaultErrorMessages[error.code]) != null ? _b3 : error.message
  };
};
...
var MediaLoadingIndicator = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes5.LOADING_DELAY && oldValue !== newValue) {
      ...
      if (oldValue) {
        (_b3 = (_a4 = __privateGet12(this, _mediaController6)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet12(this, _mediaController6)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b3;
...
var MediaPlaybackRateButton = class extends MediaChromeButton {
  ...
  handleClick() {
    ...
    const detail = (_b3 = (_a4 = availableRates.find((r) => r > this.mediaPlaybackRate)) != null ? _a4 : availableRates[0]) != null ? _b3 : DEFAULT_RATE;
    const evt = new GlobalThis.CustomEvent(
...
var MediaPreviewThumbnail = class extends GlobalThis.HTMLElement {
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      ...
      (_c = (_b3 = __privateGet15(this, _mediaController7)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
    }
  }
  disconnectedCallback() {
    var _a4, _b3;
    (_b3 = (_a4 = __privateGet15(this, _mediaController7)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
...
var formatTimesLabel = (el, { timesSep = DEFAULT_TIMES_SEP } = {}) => {
  ...
  const [, seekableEnd] = (_b3 = el.mediaSeekable) != null ? _b3 : [];
  let endTime = 0;
    ...
    for (const [expression, part] of parts) {
      ...
      if (value instanceof PartialTemplate) {
        if (templates.get(part) !== value.template) {
          ...
          (_b3 = templateInstances.get(part)) == null ? void 0 : _b3.update(value.state);
        }
        continue;
      }
      if (value) {
...
function evaluateExpression(expr, state = {}) {
  ...
  if (((_a4 = tokens[0]) == null ? void 0 : _a4.token) === ">") {
    const partial = state[(_b3 = tokens[1]) == null ? void 0 : _b3.token];
    if (!partial) {
      return invalidExpression(expr);
    }
...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
  ...
  get props() {
    ...
    const observedAttributes2 = [
      ...Array.from((_b3 = (_a4 = this.mediaController) == null ? void 0 : _a4.attributes) != null ? _b3 : []).filter(
        ({ name }) => {
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  ...
  connectedCallback() {
    ...
    (_b3 = (_a4 = __privateGet22(this, _mediaController8)) == null ? void 0 : _a4.associateElement) == null ? void 0 : _b3.call(_a4, this);
    if (!this.hidden) {
  ...
  disconnectedCallback() {
    ...
    this.disable();
    (_b3 = (_a4 = __privateGet22(this, _mediaController8)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
  ...
  get value() {
    var _a4, _b3;
    return (_b3 = (_a4 = this.checkedItems[0]) == null ? void 0 : _a4.value) != null ? _b3 : "";
  }
  set value(newValue) {
  ...
  handleMove(event) {
    ...
    const currentItem = (_b3 = (_a4 = __privateMethod8(this, _getItem, getItem_fn).call(this, event)) != null ? _a4 : __privateMethod8(this, _getTabItem, getTabItem_fn).call(this)) != null ? _b3 : items[0];
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd23(this, _handleMenuItem, () => {
      ...
      const description = (_b3 = checkedItem == null ? void 0 : checkedItem.dataset.description) != null ? _b3 : checkedItem == null ? void 0 : checkedItem.text;
...
var _a3, _b2;
var template17 = (_b2 = (_a3 = GlobalThis.document) == null ? void 0 : _a3.createElement) == null ? void 0 : _b2.call(_a3, "template");
if (template17) {
