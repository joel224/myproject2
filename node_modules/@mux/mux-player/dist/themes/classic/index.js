...
`;
  ...
  var MediaChromeMenu = class extends GlobalThis.HTMLElement {
    ...
    connectedCallback() {
      ...
      (_b3 = (_a4 = __privateGet4(this, _mediaController)) == null ? void 0 : _a4.associateElement) == null ? void 0 : _b3.call(_a4, this);
      if (!this.hidden) {
    ...
    disconnectedCallback() {
      ...
      this.disable();
      (_b3 = (_a4 = __privateGet4(this, _mediaController)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
    ...
    handleMove(event) {
      ...
      const currentItem = (_b3 = (_a4 = __privateMethod2(this, _getItem, getItem_fn).call(this, event)) != null ? _a4 : __privateMethod2(this, _getTabItem, getTabItem_fn).call(this)) != null ? _b3 : items[0];
...
`;
  var MediaChromeButton = class extends GlobalThis.HTMLElement {
    ...
    attributeChangedCallback(attrName, oldValue, newValue) {
      ...
      if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
        if (oldValue) {
          (_b3 = (_a4 = __privateGet6(this, _mediaController2)) == null ? void 0 : _a4.unassociateElement) == null ? void 0 : _b3.call(_a4, this);
    ...
    connectedCallback() {
      ...
      if (mediaControllerId) {
        ...
        (_c = (_b3 = __privateGet6(this, _mediaController2)) == null ? void 0 : _b3.associateElement) == null ? void 0 : _c.call(_b3, this);
      }
  ...
  var currentLanguage = ((_b = (_a2 = globalThis.navigator) == null ? void 0 : _a2.language) == null ? void 0 : _b.split("-")[0]) || "en";
  var t = (key, variables = {}) => {
    var _a22;
...
`;
  var MediaAudioTrackMenuButton = class extends MediaChromeMenuButton {
    ...
    constructor() {
      super({ slotTemplate: slotTemplate2, tooltipContent: t("Audio") });
    }
    connectedCallback() {
      super.connectedCallback();
...
`;
  ...
  var MediaCaptionsMenuButton = class extends MediaChromeMenuButton {
    constructor(options = {}) {
      super({ slotTemplate: slotTemplate3, tooltipContent: t("Captions"), ...options });
  ...
  var AttributeTokenList = class {
    ...
    add(...tokens) {
      ...
      (_b3 = __privateGet9(this, _el)) == null ? void 0 : _b3.setAttribute(`${__privateGet9(this, _attr)}`, `${this.value}`);
    }
    remove(...tokens) {
      var _a4;
...
`;
  var MediaRenditionMenuButton = class extends MediaChromeMenuButton {
    ...
    constructor() {
      super({ slotTemplate: slotTemplate6, tooltipContent: t("Quality") });
    }
    connectedCallback() {
      super.connectedCallback();
  ...
  MediaThemeClassic.template = (_b2 = (_a3 = template7.content) == null ? void 0 : _a3.children) == null ? void 0 : _b2[0];
