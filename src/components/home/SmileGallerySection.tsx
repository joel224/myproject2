...
function InstagramEmbed({ html, isVisible, delay }: { html: string; isVisible: boolean; delay: number }) {
  ...
  return (
    <div
      className={cn(
        'initial-fade-in-up w-full flex items-center justify-center',
    ...
    >
      {isClient ? (
        <div
          className="w-full max-w-[340px] h-full flex items-start justify-center"
          dangerouslySetInnerHTML={{ __html: html }}
        />
      ) : (
        <div className="w-full max-w-[340px] h-[500px] flex items-center justify-center">
